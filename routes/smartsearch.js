...
router.get('/:smartsearch', async function (req, res) {
    try {
        ...
        let query = `select smart.smart_num as num,smart.category as category,user.id as id,smart.title as title,smart.kind as kind,smart.product as product,smart.price as price,smart.period as period,smart.time as time, 
