...
router.get('/:brandsearch', async function (req, res) {
    try {
        ...
        let query = `select brand.brand_num as brand_num,category as category,user.id as id,brand.title as title,brand.kind as kind,brand.product as product,brand.price as price,brand.period as period,brand.time as time, 
