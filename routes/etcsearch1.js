...
router.get('/:etcsearch', async function (req, res) {
    try {
        ...
        let query = `select etc.etc_num as etc_num,etc.category as category,user.id as id,etc.title as title,etc.kind as kind,etc.product as product,etc.price as price,etc.period as period,etc.time as time, 
